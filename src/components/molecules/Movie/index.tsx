...
export default function Movie({ item }: { item: any }) {
  ...
  return (
    <div className="max-w-sm rounded overflow-hidden bg-[#1a1a1a] shadow-lg flex flex-col">
      ...
      <div className="px-1 py-4 flex justify-between">
        <button
          ...
          className={`flex items-center outline-none text-[14px] rounded-md text-white cursor-pointer py-1 px-2 hover:text-black hover:bg-teksActive transition-all ease-out`}
        >
        ...
        <button
          onClick={() => handleWatchList(item)}
          className={`flex items-center outline-none bg-teksActive text-[14px] rounded-md text-black cursor-pointer py-1 px-2 hover:bg-white transition-all ease-out`}
        >
